...
const Projects = () => {
  ...
  {projects.map((project, index) => (
    <div
      key={project.name}
      className="lg:w-[400px] w-full bg-white/10 backdrop-blur-md p-6 rounded-2xl shadow-md 
                 transition-all duration-300 ease-out transform hover:-translate-y-10 
                 hover:scale-105 hover:border hover:border-blue-500 hover:shadow-blue-500/30"
      data-aos="fade-up"
